...
// AnimationSequence
//=============================================================================================
    //AnimationSequence::AnimationSequence( const std::string & name, uint32_t nbframes )
    //    :m_frames(nbframes), m_name(name)
    //{}

    //uint32_t AnimationSequence::insertFrame( AnimFrame && aframe, int index ) //Inserts a frame. If index == -1, inserts at the end! Return index of frame!
    //{
    ...
    //static const string SPRITE_Palette_XML = "palette.xml";
    ...
    //static const string SPRITE_Palette     = "palette.pal";
...
//        { 
//            SpriteXMLParser myparser( &m_outSprite );
